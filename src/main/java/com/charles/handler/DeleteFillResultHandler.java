 ...
 * @author dell
 */
public class DeleteFillResultHandler extends BaseFillResultHandler{
    public DeleteFillResultHandler(OperationEnum operation) {
        super(operation);
    }
    ...
    public void fillResult(List<Element> elements, CompareExcelLine compareExcelLine) {
        if (CollectionUtils.isNotEmpty(elements)) {
            for (Element element : elements) {
                compareExcelLine.getLocalText().append(element.getStringValue()).append(System.lineSeparator());
